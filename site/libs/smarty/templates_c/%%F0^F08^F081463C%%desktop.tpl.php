<?php /* Smarty version 2.6.11, created on 2025-11-27 20:08:17
         compiled from admin/desktop/desktop.tpl */ ?>
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="desktop">
        ...
        <div class="desktop-shortcuts">
            <?php if ($this->_tpl_vars['moduleAccess']['banners']): ?>
            <div class="shortcut" onclick="openBanners()">
                <div class="shortcut-icon"><span class="material-icons">image</span></div>
            ...
            <?php if ($this->_tpl_vars['moduleAccess']['permissions']): ?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['moduleAccess']['users']): ?>
    ...
    <div class="taskbar">
        ...
        <div class="system-tray">
            ...
            <button class="tray-button" onclick="showUserMenu()" title="<?php echo $this->_tpl_vars['admin_user']['name']; ?>
">
    ...
    <div id="start-menu-modal">
        ...
        <div id="user">
            ...
            <a href="#" onclick="showProfile(); return false;" title="<?php echo $this->_tpl_vars['admin_user']['name']; ?>
">
                <span class="material-icons">person</span>
            </a>
        ...
        <div id="apps">
            ...
            <?php if ($this->_tpl_vars['moduleAccess']['menu']): ?>
            ...
            <?php if ($this->_tpl_vars['moduleAccess']['products']): ?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['moduleAccess']['import']): ?>
    ...
    function showUserMenu() {
        Ext.Msg.alert('Профиль', '<b>Логин:</b> <?php echo $this->_tpl_vars['admin_user']['login']; ?>
<br><b>Имя:</b> <?php echo $this->_tpl_vars['admin_user']['name']; ?>
');
    }
                            ...
                            drop: function(node, data, overModel, dropPosition) {
                                ...
                                Ext.Ajax.request({
                                    ...
                                    success: function(response) {
                                        ...
                                        // Успешное сохранение происходит тихо, без уведомлений
                                    },
                                    failure: function() {
