<?php /* Smarty version 2.6.11, created on 2025-12-24 22:05:36
         compiled from sfera/tpl/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'mod', 'sfera/tpl/header.tpl', 96, false),)), $this); ?>
<!-- Header -->
<header class="header">
    ...
    <div class="header-container">
        <div class="location-content">
            ...
            <div class="social-icons">
                    ...
                    <a href="https://www.instagram.com/sfera_book/" class="social-icon" rel="nofollow">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
                    ...
                    <a href="https://www.facebook.com/Sferabook" class="social-icon" rel="nofollow">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
        ...
        <div class="header-container">
            ...
            <div class="catalog-dropdown" id="catalogDropdown">
                ...
                <div class="catalog-menu">
                    <?php echo smarty_function_mod(array('path' => "sfera/",'mod_name' => 'catalog_menu'), $this);?>
...
<?php else: ?>
  <!-- НЕ АВТОРИЗОВАН -->
  <a href="#" id="login-open-link" class="header-action" onclick="openSmsModal(); return false;">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="2"/>
      <path d="M5 20c0-4 3-7 7-7s7 3 7 7" stroke="currentColor" stroke-width="2"/>
    </svg>
...
<?php endif; ?>              
                ...
                <a href="/favorites/" class="header-action">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M12 21c-1.5 0-2.5-1-3-2H6l-2-2V7c0-1 1-2 2-2h12c1 0 2 1 2 2v10l-2 2h-3c-.5 1-1.5 2-3 2z" stroke="currentColor" stroke-width="2"/>
                        <path d="M12 8v4m0 2v2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                    <span>Избранное</span>
                </a>
                <a href="/cart/" class="header-action header-action-cart">
                    ...
                    <span>Корзина</span>
                    <span class="mobile-nav-badge" style="right:20%;top:-10px;">3</span>
                </a>
    ...
    <div class="header-secondary">
        <div class="header-container">
            <?php echo smarty_function_mod(array('path' => "sfera/",'mod_name' => 'secondary_nav'), $this);?>
