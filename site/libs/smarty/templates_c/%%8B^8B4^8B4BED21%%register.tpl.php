<?php /* Smarty version 2.6.11, created on 2025-11-29 14:19:45
         compiled from sfera/auth/register.tpl */ ?>
    ...
    <div class="container">
        <div class="login-container">
            <div class="login-card">
                ...
                <?php if ($this->_tpl_vars['errors'] && count ( $this->_tpl_vars['errors'] )): ?>
                    <ul class="error-list">
                ...
                <form class="register-form" action="/register/" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" id="login" name="login"
                               value="<?php echo $this->_tpl_vars['old']['login']; ?>
" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name"
                               value="<?php echo $this->_tpl_vars['old']['name']; ?>
">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email"
                               value="<?php echo $this->_tpl_vars['old']['email']; ?>
" placeholder="example@mail.ru">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone"
                               value="<?php echo $this->_tpl_vars['old']['phone']; ?>
