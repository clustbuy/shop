<?php /* Smarty version 2.6.11, created on 2025-11-29 12:48:16
         compiled from sfera/register/register.tpl */ ?>
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
...
<div class="auth-container">
    ...
    <form action="/auth/register" method="POST" class="auth-form">
        ...
        <a href="/auth/login" class="btn btn-link">Вход</a>
    </form>
</div>
<?php else: ?>
<div class="auth-container-mobile">
    ...
    <form action="/auth/register" method="POST" class="auth-form-mobile">
