                    ...
                    if (settings.on === 'click') {
                        $source.on('click.zoom', function(e){
                            if (clicked) {
                                ...
                                start(e);
                                $(document).on(mousemove, zoom.move);
                                $(document).one('click.zoom', function(e){
                                    if ($('.pdp-img .photo').hasClass('zoomed')) {
                                        setTimeout(function(){
                                            $('.pdp-img .photo').removeClass('zoomed');
                                            $('.pdp-img .photo').parent().css('position', 'relative');
                                            $('.pdp-img .photo').find('a').show();
                                        }, 200);
                                    }
                                    stop();
                                    clicked = false;
