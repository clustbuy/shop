...
<html lang="ru">
	...
	<head>
		<meta charset="utf-8">
		<title>~~$category.title~ : Cкладской магазин ru.market</title>
	...
	<body>
					...
					<div class="l-catalog">
						...
						<main class="l-catalog__main">
							<div class="catalog-items">
								...
								~~mod path="market/controllers/" mod_name="catalog" action=$post current=$c_data.current nodes=$post.nodes cat_alias=$cat_alias  viewmode='main'~
								
								<script>
								attach_component_item({
									class_target:               '.catalog-items__cell',
								...
								<div class="catalog-items__brands">
									...
									<div class="brands-links">
										...
										<div class="brands-links__item">
											<a href="/brand/~~$brand.id~" class="brand-link">
												<span class="brand-link__name">~~$brand.name~</span>
												<span class="brand-link__count">(~~$brand.count~)</span>
											</a>
										</div>
										~~/foreach~
									</div>
		...
		<script>
			$(document).ready(function(){
				setTimeout(function(){
					sameHeight('.catalog-items__list', '.catalog-items__cell');
				}, 10);
			});
		</script>
	</body>
