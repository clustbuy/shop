...
<html lang="ru">
	...
	<head>
		<meta charset="utf-8">
		<title>~~$p_data.product.0.title~ : Cкладской магазин ru.market</title>
						...
						<div class="item-click">
							<div class="item-click__inn">
								<div class="item-click__photo">
									<a href="#"> <img class="item-click__img" src="~~$p_data.product[0].img_url~"> </a>
								</div>
								<div class="item-click__info">
									<a href="#" class="item-click__name">~~$p_data.product[0].name~</a>
									<div class="item-click__num">
										<div class="item-count js-item-count" data-price="~~$p_data.product[0].cost~" data-max="11">
									...
									<div class="price">
										<span class="js-item-click-price js-odometer">~~$p_data.product[0].cost~</span> р.
									</div>
								</div>
							</div>
						</div>
...
~~*debug*~
						...
						<div class="item__main" data-id="~~$p_data.product.0.id~" id="item~~$p_data.product.0.id~">
							<div class="item__main-left">
								<div class="item-gallery">
										...
										<div>
											<div class="swiper-container js-item-gallery">
												<div class="swiper-wrapper">
													...
													~~foreach from=$p_data.product[0].gallery item=photo~
													<div class="swiper-slide"><img data-zoom-image="~~$photo.url~" src="~~$photo.url~" style="height:450px;"></div>
													~~/foreach~
									...
									~~if isset($p_data.product[0].gallery) && count($p_data.product[0].gallery)>0~
									<div class="item-gallery__thumbs">
										<div class="swiper-container js-item-gallery-thumbs">
											<div class="swiper-wrapper">
										...
										<div class="item-meta__group">
											...
											*~
											...
											<div class="item-meta__actions">
												...
												<div class="item-meta__actions-inn">
													<div class="item-meta__actions-cart">
														<a href="#cart" class="btn btn--vinous item-meta__cart waves-effect waves-light"> <i class="ticon ticon-cart "></i> Добавить в корзину</a>
													</div>
													<div class="item-meta__actions-fav">
										...
										<div class="item-meta__group">
											<div class="item-meta__colors">
												<div class="item-meta__label">
													...
													~~foreach from=$p_data.product[0].params item=param~
						...
						attach_component_item({
							class_target:               'div.item__main',
							class_inside_target:    '.item-meta__actions',
							viewmode:             'item',
							lazyload:             true,
							params:       {
								show_controls: 1
					...
					~~if $p_data.product[0].parameters || $p_data.product[0].description~
					<div class="l-wrapper">
							...
							<div data-el="tabs" class="desc-tabs js-tabs">
								...
								<div class="desc-tabs__content">
									...
									<div data-el="pane" id="desc_tab_1" class="desc-tabs__pane ~~if $hasActiveDescTab=="false"~is-active ~~assign var="hasActiveDescTab" value="true"~~~/if~">
										<div class="text">
											<p>~~$p_data.product[0].description~<p>
										</div>
										~~*
										...
										<div class="text">
											~~if $p_data.product[0].parameters~
												<div class="table-chars">
													~~foreach from=$p_data.product[0].parameters item=param name=param~
