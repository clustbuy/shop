...
switch ($p['task']) {
  ...
  */
    ...
    case 'get_pickpoint_list': 
                ...
                $res = rows("SELECT id,pickup_id,lo,la FROM _y_points WHERE la > ".$coords[0][0]." AND la < ".$coords[1][0]." AND lo > ".$coords[0][1]." AND lo < ".$coords[1][1]." ");

                $sql = "SELECT id,pickup_id,lo,la FROM _y_points WHERE la > ".$coords[0][0]." AND la < ".$coords[1][0]." AND lo > ".$coords[0][1]." AND lo < ".$coords[1][1]." ";
    ...
    case 'get_pickpoint_data':
                ...
                $point_data = row("SELECT * FROM _y_points WHERE la = ".$p['coords'][0]." AND lo = ".$p['coords'][1]);
