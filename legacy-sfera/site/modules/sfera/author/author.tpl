...
<head>
    ...
    <title>Книги автора: ~~$author.name~ - Творческий Центр СФЕРА</title>
            ...
            <div class="catalog-content">
                ...
                <div class="catalog-toolbar">
                    <div class="toolbar-left">
                        ...
                        <span class="results-count" id="resultsCount">Найдено ~~$total~ ~~if $total == 1~книга~~else~книг~~/if~</span>
                    </div>
...
~~if $page > 1~
                    <a href="/author/?author_name=~~$author.name|urlencode~&page=~~$page-1~" class="pagination-btn">
...
~~else~
                    <a href="/author/?author_name=~~$author.name|urlencode~&page=~~$pageNum~" class="pagination-btn">~~$pageNum~</a>
~~/if~
~~/section~
~~if $page < $pages~
                    <a href="/author/?author_name=~~$author.name|urlencode~&page=~~$page+1~" class="pagination-btn">
