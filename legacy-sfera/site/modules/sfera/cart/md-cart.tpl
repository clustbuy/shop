    ...
    <div class="item-click item-click--row">
        ...
        <div class="item-click__inn">
            <div class="item-click__photo">
                <a href="#" data-bind="attr: {href: `https://ru.market/product/${guid()}`}"> <img class="item-click__img"  data-bind="attr:{src: `https://ru.market/i/${guid()}/400/1.jpg`}" /> </a>
            </div>
            <div class="item-click__info">
                <div class="item-click__row">
                    <div>
                        <a href="#" class="item-click__name" data-bind="text: title, attr: {href: `/product/${guid()}`}"></a>
                    </div>
    ...
    *~
    ...
    <div class="md-cart__bottom">
        ...
        <div class="md-cart__bottom-right">
            <a href="/order/" class="btn btn--vinous" data-bind="visible: total_cart_amount() > 0">Оформить заказ</a>
        </div>
