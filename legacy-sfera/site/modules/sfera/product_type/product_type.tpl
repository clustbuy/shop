...
~~if $page > 1~
                    <a href="/product_type/?product_type_id=~~$product_type.id~&page=~~$page-1~" class="pagination-btn">
...
~~else~
                    <a href="/product_type/?product_type_id=~~$product_type.id~&page=~~$pageNum~" class="pagination-btn">~~$pageNum~</a>
~~/if~
~~/section~
~~if $page < $pages~
                    <a href="/product_type/?product_type_id=~~$product_type.id~&page=~~$page+1~" class="pagination-btn">
