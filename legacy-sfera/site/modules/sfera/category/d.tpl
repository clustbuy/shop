...
<body class="archive tax-product_cat term-retro-fashion term-45 logged-in wp-embed-responsive theme-avanam woocommerce woocommerce-page woocommerce-js color-switch-light has-dark-logo woocommerce-active product-style-1 products-no-gutter hfeed footer-on-bottom link-style-no-underline ~~if $cat_menu|@count >0~ has-sidebar  has-left-sidebar ~~/if~ content-title-style-above content-width-normal content-style-unboxed content-vertical-padding-show non-transparent-header mobile-non-transparent-header base-elementor-colors tax-woo-product elementor-default elementor-kit-54 e--ua-blink e--ua-chrome e--ua-webkit">
            ...
            <div class="entry-hero-container-inner">
                ...
                <div class="hero-container site-container">
                    <header class="entry-header product-archive-title title-align-inherit title-tablet-align-inherit title-mobile-align-inherit">
                        ~~mod path="elilife/" mod_name="breadcrumbs" tpl="category" node=`$category.parent_id`~
            ...
            <div class="content-container site-container">
                ...
                <aside id="secondary" role="complementary" class="primary-sidebar widget-area sidebar-slug-sidebar-woocommerce-shop sidebar-link-style-normal">
                    <div class="sidebar-inner-wrap">
                        ...
                        ~~*include file="elilife/category/widgets/product-highlight.tpl"*~
                        ~~*include file="elilife/category/widgets/product-layered-nav.tpl"*~
                        ~~*include file="elilife/category/widgets/product-price-filter.tpl"*~
                        ~~*include file="elilife/category/widgets/product-rating-filter.tpl"*~
