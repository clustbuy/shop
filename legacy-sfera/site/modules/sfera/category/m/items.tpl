...
<div class="ix9 i9x iy0">
    <a href="/product/~~$item.guid~/"  class="v5i i7v">
        <div highfetchpriority="true" class="i4v vi4">
            ...
            ~~if $item.cost > 500~
            <section class="~~*h9a ai*~ item_bonus">
                <div class="ia ai0">
                    <div tabindex="1" class="a0i b411-a0 b411-a5 b411-a1" style="background-color:rgba(16, 196, 76, 1);color:#FFFFFF;">
                        <div class="b411-b">
            ...
            <div class="iw wi0 wi">
                <div class="f f1 f4 i9v">
                    <div class="e9 a2429-a a2429-a3">
                        <a tabindex="0"  href="#card" data-remodal-target="cart" onclick="a2c('~~$item.guid~'); return;" class="a2429-a4 a2429-a3" style="border-radius:8px;">
